    ...
    <!-- jquery-validation -->
    <script src="<?= base_url() ?>assets/AdminLTE-3.0.5/plugins/jquery-validation/jquery.validate.min.js"></script>
    <script src="<?= base_url() ?>assets/AdminLTE-3.0.5/plugins/jquery-validation/additional-methods.min.js"></script>
