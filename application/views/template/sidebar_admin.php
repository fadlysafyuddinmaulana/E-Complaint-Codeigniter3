...
<aside class="main-sidebar sidebar-dark-info elevation-4">
    ...
    <a href="index3.html" class="brand-link navbar-info">
        ...
        <span class="brand-text font-weight-light">Admin sikemas</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img style="background-color: white; width: 35px; height: 35px;" src="<?= base_url('upload/' . $foto); ?>" class="img-circle elevation-2" alt="User Image" />
            </div>
            <div class="info">
